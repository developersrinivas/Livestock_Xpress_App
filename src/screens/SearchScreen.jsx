...
const SearchScreen = () => {
  const [animals, setAnimals] = useState([
    ...
    { id: '2', name: 'Nubian Goat', price: 350, image: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Nubian_goat_01.jpg', status: 'New listing' },
    { id: '3', name: 'Suffolk Sheep', price: 220, image: 'https://upload.wikimedia.org/wikipedia/commons/e/e9/Suffolk_sheep_lambs.jpg', status: '' },
    { id: '4', name: 'Quarter Horse', price: 1600, image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Quarter_horse.jpg', status: 'Featured' },
    { id: '5', name: 'Berkshire Pig', price: 400, image: 'https://upload.wikimedia.org/wikipedia/commons/d/da/Berkshire_pig.jpg', status: '' },
    { id: '6', name: 'Angus Cow', price: 1300, image: 'https://upload.wikimedia.org/wikipedia/commons/6/66/Black_Angus_cow.jpg', status: 'High demand' },
    { id: '7', name: 'Boer Goat', price: 380, image: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Boer_Goat_Buck_at_Zoo_Tampa_at_Lowry_Park.jpg', status: '' },
    { id: '8', name: 'Dorset Sheep', price: 210, image: 'https://upload.wikimedia.org/wikipedia/commons/1/1d/Dorset_Horn_sheep.jpg', status: 'Last one left!' },
